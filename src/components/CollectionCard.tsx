    ...
    return (
        ...
        >
            <div className={`${transition ? "transition-opacity duration-700 ease-in-out" : ""} ${focused ? "opacity-100" : "opacity-0"}`}>
                <div className="absolute inset-0 rounded-xl bg-linear-to-b from-transparent to-black/40 -z-5" />
                <div className="absolute inset-0 rounded-xl bg-linear-to-b from-transparent to-accent/50 -z-10" />
            </div>
