export default function LoadingCollectionCard({ size }: { size: "small" | "large" }) {
    return (
        <button
            className={`${size === "small" ? "max-w-83 w-full aspect-[3/1]" : "max-w-273 w-full aspect-[3/1]"} p-4 shrink-0 relative bg-primary/35 light:bg-primary-light/35 border border-white/30 light:border-white/80 backdrop-blur-[32px] rounded-xl shadow-[0px_6px_15px_0px_rgba(0,0,0,0.15)]`}
        >
